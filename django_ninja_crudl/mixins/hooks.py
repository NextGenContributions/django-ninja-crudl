...
class HooksMixin(Generic[TDjangoModel_co], ABC):
    ...
    def pre_create(self, request: RequestDetails[TDjangoModel_co]) -> None:
        """Pre-create hook.

        Can be used to perform some actions or checks before creating the object.
        """

    def post_create(self, request: RequestDetails[TDjangoModel_co]) -> None:
        """Post-create hook.

        Can be used to perform some actions after creating the object.
        """

    def pre_update(self, request: RequestDetails[TDjangoModel_co]) -> None:
        """Pre-update hook.

        Can be used to perform some actions or checks before updating the object.
        """

    def post_update(self, request: RequestDetails[TDjangoModel_co]) -> None:
        """Post-update hook.

        Can be used to perform some actions after updating the object.
        """

    def pre_patch(self, request: RequestDetails[TDjangoModel_co]) -> None:
        """Pre-patch hook.

        Can be used to perform some actions or checks before patching the object.
        """

    def post_patch(self, request: RequestDetails[TDjangoModel_co]) -> None:
        """Post-patch hook.

        Can be used to perform some actions after patching the object.
        """

    def pre_delete(self, request: RequestDetails[TDjangoModel_co]) -> None:
        """Pre-delete hook.

        Can be used to perform some actions or checks before deleting the object.
        """

    def post_delete(self, request: RequestDetails[TDjangoModel_co]) -> None:
        """Post-delete hook.
