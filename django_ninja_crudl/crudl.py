...
#     update_response_fields: ClassVar[ModelFields] = None
...
#             update_response_fields: ModelFields | None = api_meta.update_response_fields
...
#                 """Response schema for the update operation."""
#
#                 class Meta(Schema.Meta):
#                     """Pydantic configuration."""
#
#                     name = f"{model_class.__name__}_UpdateResponse"
#                     model = model_class
#                     fields = update_response_fields if update_response_fields else None
#
#             PartialUpdateResponseSchema = PatchDict[UpdateResponseSchema]  # pyright: ignore[reportInvalidTypeArguments]  # noqa: N806 # NOSONAR
#
#         if list_fields:
#
...
#                             # TODO(phuongfi91): using validating_manager later as well?
...
#                     response={
#                         status.HTTP_200_OK: UpdateResponseSchema,  # pyright: ignore[reportPossiblyUnboundVariable]
#                         status.HTTP_401_UNAUTHORIZED: Unauthorized401Schema,
#                         status.HTTP_403_FORBIDDEN: Forbidden403Schema,
#                         status.HTTP_404_NOT_FOUND: ResourceNotFound404Schema,
#                         status.HTTP_422_UNPROCESSABLE_ENTITY: UnprocessableEntity422Schema,
...
#                                     return self.get_404_error(request)
#                         else:
#                             # TODO(phuongfi91): releated_obj is unused
#                             related_obj = related_model_class.objects.get(
#                                 id=m2m_field_value,
#                             )
#
...
#                     response={
#                         status.HTTP_200_OK: PartialUpdateResponseSchema,  # pyright: ignore[reportPossiblyUnboundVariable]
#                         status.HTTP_401_UNAUTHORIZED: Unauthorized401Schema,
#                         status.HTTP_403_FORBIDDEN: Forbidden403Schema,
#                         status.HTTP_404_NOT_FOUND: ResourceNotFound404Schema,
#                         status.HTTP_422_UNPROCESSABLE_ENTITY: UnprocessableEntity422Schema,
...
#                     m2m_fields_to_set: list[tuple[str, Any]] = []  # pyright: ignore[reportExplicitAny]
#
#                     # TODO(phuongfi91): payload is a dict here, no model_dump() method
